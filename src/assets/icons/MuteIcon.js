...
export default function MuteIcon() {
  return (
    ...
    <g filter="url(#filter0_b_1238_686)">
    <circle cx="40" cy="40" r="40" fill="black" fill-opacity="0.14"/>
    </g>
    <g clip-path="url(#clip0_1238_686)">
    ...
    <defs>
    <filter id="filter0_b_1238_686" x="-30" y="-30" width="140" height="140" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
    <feFlood flood-opacity="0" result="BackgroundImageFix"/>
    <feGaussianBlur in="BackgroundImageFix" stdDeviation="15"/>
    <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_1238_686"/>
    <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_1238_686" result="shape"/>
    </filter>
    <clipPath id="clip0_1238_686">
