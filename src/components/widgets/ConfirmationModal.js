        ...
        <div className="fixed top-0 left-0 w-full h-full z-20 bg-modalbg flex items-center justify-center text-white">
          <div className="w-[600px]">
            <div className="bg-gradient-to-t from-[#212234] via-[#24253C] to-[#6C7EFF] rounded-[20px]">
              ...
              <div className="flex justify-center">
                {/* <div className=''> */}
                  <img src={ModalLayer} alt='ModalLayer' className='block w-full rounded-s-[20px] rounded-e-[20px]' />
                {/* </div> */}
              </div>
              <div className="px-10 pb-10">
                ...
                <p className="text-lg text-center font-thin opacity-[.6] line-clamp-5 mb-3">
                ...
                {currentPersonaId?.code && <div className="flex justify-center mb-2 mt-4">
